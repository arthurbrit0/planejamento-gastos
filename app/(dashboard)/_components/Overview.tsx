...
function Overview({configuracoesUser}: {configuracoesUser: ConfiguracoesUser}) {
    ...
    const [rangeData, setRangeData] = useState<{from: Date, to: Date}>({            // criando o estado do range de data, tipando o from e o to com Date
    ...
    <>
        <div className="container mx-auto flex flex-wrap justify-between gap-2 py-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <DateRangePicker initialDateFrom={rangeData.from} initialDateTo={rangeData.to} showCompare={false} onUpdate={ // importamos o componente DateRangePicker, passando o from e o to como props, para mostrar o range de data inicial
        ...
        <div className="container flex w-full flex-col gap-2 mx-auto">
            <StatsCards configuracoesUser={configuracoesUser} from={rangeData.from} to={rangeData.to} /> {/* passamos as configurações do usuário e o range de data para o componente StatsCards */}
        </div>

        <div className="container flex w-full flex-col gap-2 mx-auto mt-5">
            <CategoriasCards configuracoesUser={configuracoesUser} from={rangeData.from} to={rangeData.to} /> {/* passamos as configurações do usuário e o range de data para o componente CategoriasCards */}
        </div>        
    </>
  )
}
